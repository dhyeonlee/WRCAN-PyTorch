...
parser.add_argument('--degradation', action='store_true',
                    help='Degradation model, which is inverse of SR.')
...
parser.add_argument('--n_depth', type=int, default=2, 
                    help='number of depth of UNet architecture')
...
parser.add_argument('--precision', type=str, default='amp',
                    choices=('single', 'half', 'amp'),
                    help='FP precision for test (single | half | amp). AMP is automatic mixed precision')
# parser.add_argument('--amp', action='store_true', 
#                     help='Trun on Automatic mixed precision')
...
parser.add_argument('--gan_arch', type=str, default='',
                    help='Discriminator architecture of GANs. (rp, patch, kernel, vanilla)')
